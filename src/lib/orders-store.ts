...
function seedDemoOrdersIfNeeded() {
  ...
  if (pendingListing) {
    orders.push({
      ...
      platform_fee: +(pendingListing.price * 2 * 0.10).toFixed(2),
      creator_payout: +(pendingListing.price * 2 * 0.90).toFixed(2),
  ...
  if (pendingListing) {
    orders.push({
      ...
      platform_fee: +(pendingListing.price * 0.10).toFixed(2),
      creator_payout: +(pendingListing.price * 0.90).toFixed(2),
      notes: null,
  ...
  if (pendingListing) {
    orders.push({
      ...
      platform_fee: +(pendingListing.price * 3 * 0.10).toFixed(2),
      creator_payout: +(pendingListing.price * 3 * 0.90).toFixed(2),
